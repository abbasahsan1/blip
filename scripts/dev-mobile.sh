...
cat <<EOF > "${ENV_FILE}"
EXPO_PUBLIC_GATEWAY_URL=http://${DEV_HOST_IP}:8419
EXPO_PUBLIC_API_URL=http://${DEV_HOST_IP}:8419
EXPO_PUBLIC_CONTENT_INGEST_URL=http://${DEV_HOST_IP}:8419
EXPO_PUBLIC_FEED_URL=http://${DEV_HOST_IP}:8419
EXPO_PUBLIC_SOCIAL_GRAPH_URL=http://${DEV_HOST_IP}:8419
EXPO_PUBLIC_MESSAGING_URL=http://${DEV_HOST_IP}:8419
EXPO_PUBLIC_MODERATION_URL=http://${DEV_HOST_IP}:8419
EXPO_PUBLIC_MINIO_URL=http://${DEV_HOST_IP}:8419
EXPO_PUBLIC_KEYCLOAK_URL=http://${DEV_HOST_IP}:8419
S3_PUBLIC_ENDPOINT_URL=http://${DEV_HOST_IP}:8419
EOF
